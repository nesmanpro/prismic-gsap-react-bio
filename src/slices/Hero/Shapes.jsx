...
function Geometries() {
    const geometries = [
        ...
        },
        {
            position: [1.6, 1.6, -4],
            r: 0.4,
            geometry: new THREE.OctahedronGeometry(1.5) //Diamon
        },
    ]

    const materials = [
        new THREE.MeshNormalMaterial(),
        new THREE.MeshStandardMaterial({ color: 0x58B19F, roughness: 0 }),
        new THREE.MeshStandardMaterial({ color: 0xFC427B, roughness: 0.2 }),
        new THREE.MeshStandardMaterial({ color: 0xeccc68, roughness: 0.4 }),
        new THREE.MeshStandardMaterial({ color: 0xf19066, roughness: 0.1 }),
        new THREE.MeshStandardMaterial({ color: 0x3dc1d3, roughness: 0.3 }),
        new THREE.MeshStandardMaterial({ color: 0x574b90, roughness: 0.5 }),

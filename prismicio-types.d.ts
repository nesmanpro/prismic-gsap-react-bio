...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Fallback image item field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.fallback_image_item
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Item in *Experience → Default → Primary → item details*
 */
export interface ExperienceSliceDefaultPrimaryItemDetailsItem {
  /**
   * Title field in *Experience → Default → Primary → item details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.item_details[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time period field in *Experience → Default → Primary → item details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.item_details[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Intitution field in *Experience → Default → Primary → item details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.item_details[].intitution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  intitution: prismic.KeyTextField;

  /**
   * Description field in *Experience → Default → Primary → item details*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.item_details[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
export interface ExperienceSliceDefaultPrimary {
  ...
  /**
   * item details field in *Experience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.item_details[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  item_details: prismic.GroupField<
    Simplify<ExperienceSliceDefaultPrimaryItemDetailsItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperienceSlice,
      ExperienceSliceDefaultPrimaryItemDetailsItem,
